...
"""
Discover command implementation for finding K3s-tagged VMs.

This module handles the 'discover' command which finds K3s VMs by tags
and can output configuration data or update config.json.
"""
